...
public class StudentInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noti=(Button)findViewById(R.id.notification2);
        noti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(StudentInformationActivity.this,NotificationActivity.class);
        ...
        try{
            ...
            DatabaseReference databaseReference=database.getReference().child("students");
